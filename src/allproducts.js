const allproducts ={
    ...
    electronics:{
        productos:[
            {name:'portatil', price: 1500, img:'/productos/tomate.png'},
            {name:'ram', price: 2000, img:'/productos/cebolla.png'},
            {name:'procesador', price: 500, img:'/productos/lechuga.png'},
            {name: 'cooler', price: 2500, img:'/productos/aguacate.png'},
            {name: 'pepino', price: 900, img:'/productos/pepino.png'},
            {name: 'papa', price: 700, img:'/productos/papa.png'},
            {name: 'zanahoria', price: 300, img:'/productos/zanahoria.png'},
            {name: 'brocoli', price: 3000, img:'/productos/brocoli.png'},
